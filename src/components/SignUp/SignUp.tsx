        ...
        <div className="flex flex-col lg:flex-row h-full w-full">
          <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
            ...
            <div
              ...
              data-alt="High-end fashion model in luxury minimalist clothing"
              style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuA8fVcjJiCmVof7UbWRnEXEC_WxBLaFzkeb6UTEUTEwLZV-qR6rLUHHLtXfjMyhMh3Cqxquf2BK8IebszQVxlY2BiYrJ0HTrWMNRWOSehkEkZgdsM2A2Fy7z59ko6lxU3gLempNG0bH1vnfBE1_xtaWeyXIZ06MzVoBdqa1Pk9NcAcDI_8bQibJ85wLc9LwL5JcWE7S6_l3Rk30e4WW_5G2iDXebNYTyLRW68de_SauKUfTFr6LvHts4UUAEN1zvKJi4GDaoGyCzUM')" }}
            ></div>
          ...
          <div className="flex-1 flex flex-col justify-start items-center p-4 md:p-6 lg:p-8 bg-background-light dark:bg-background-dark overflow-y-auto">
            <div className="w-full max-w-md flex justify-between items-center mb-8 mt-8">
            ...
            <div className="w-full max-w-md space-y-6">
              ...
              <div className="text-center pb-8">
                <p className="text-slate-500 dark:text-slate-400">
                  ...
                  <Link
                    className="font-bold text-primary dark:text-slate-100 hover:text-accent transition-colors"
                    to="/login"
                  >
                    Login
                  </Link>
